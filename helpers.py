...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 23 17:36:38 2020
...
def Euler_ZXZ_Matrix(psi, theta, sigma):
...
def minimize_Reprojection(dof,d2dPoints1, d2dPoints2, d3dPoints1, d3dPoints2, w2cMatrix):
    Rmat = Euler_ZXZ_Matrix(dof[0], dof[1], dof[2])
...
def generate_3D_Points(points2D_L, points2D_R, Proj1, Proj2):
